...
import (
	...
	"github.com/evocert/kwe/go_ora/go_oraext/advanced_nego"
	"github.com/evocert/kwe/go_ora/go_oraext/converters"
	"github.com/evocert/kwe/go_ora/go_oraext/network"
)
...
func init() {
	sql.Register("kwe:oracle:ext", &OracleDriver{})
}
