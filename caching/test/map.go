...
func NewMapHandler(a ...interface{}) (mphndlr *MapHandler) {
	...
	if mp != nil {
		mphndlr = &MapHandler{mp: mp, intern: false, dspsng: false, rnble: rnble, crntmp: nil, prnthndlr: prnthndlr, hndlrs: map[*MapHandler]*MapHandler{}, crntactnstmp: -1}
	} else {
		mphndlr = &MapHandler{mp: NewMap(), intern: true, dspsng: false, rnble: rnble, crntmp: nil, prnthndlr: prnthndlr, hndlrs: map[*MapHandler]*MapHandler{}, crntactnstmp: -1}
	}
...
func (mphndlr *MapHandler) Reset(ks ...interface{}) {
	if mphndlr != nil && mphndlr.mp != nil {
		...
		if len(ks) > 0 {
			if vfound := mapFind(mphndlr.crntmp, mphndlr, ks...); vfound != nil {
...
func (mp *Map) lastAction(mphndlr *MapHandler, nxtactn ...mapAction) (mpAction mapAction, actntr *actionTransaction) {
	if mp != nil {
		if len(nxtactn) == 1 {
			mpAction = func() mapAction {
				mp.lck.Lock()
				defer mp.lck.Unlock()
				crntactn := nxtactn[0]
				if lstactn, nxtctn := mp.lstactn, crntactn; nxtctn != lstactn {
...
func mapFprint(mp *Map, mphndlr *MapHandler, w io.Writer, ks ...interface{}) (err error) {
	...
	if mp != nil && w != nil {
		if lstactn, actntr := mp.lastAction(mphndlr, actnwrite); !(lstactn == actnclear || lstactn == actnclose) && lstactn == actnwrite {
			func() {
				defer func() {
					if actntr == nil {
						mp.lastAction(mphndlr, actnnone)
					}
				}()
				func() {
...
func mapReader(mp *Map, mphndlr *MapHandler, ks ...interface{}) (mprdr *iorw.EOFCloseSeekReader) {
	...
	if mp != nil {
		if lstactn, actntr := mp.lastAction(mphndlr, actnread); !(lstactn == actnclear || lstactn == actnclose) && lstactn == actnread {
			func() {
				defer func() {
					if actntr == nil {
						mp.lastAction(mphndlr, actnnone)
...
func mapFind(mp *Map, mphndlr *MapHandler, ks ...interface{}) (vfound interface{}) {
	...
	if mp != nil {
		if lstactn, actntr := mp.lastAction(mphndlr, actnfind); !(lstactn == actnclear || lstactn == actnclose) && lstactn == actnfind {
			func() {
				defer func() {
					if actntr == nil {
						mp.lastAction(mphndlr, actnnone)
...
func mapRemove(forceRemove bool, mp *Map, mphndlr *MapHandler, a ...interface{}) {
	...
	if mp != nil {
		if len(a) > 0 {
			if lstactn, actntr := mp.lastAction(mphndlr, actnremove); (forceRemove && (lstactn == actnclear || lstactn == actnclose)) || (!forceRemove && (!(lstactn == actnclear || lstactn == actnclose) && lstactn == actnremove)) {
				defer func() {
					if actntr == nil {
						mp.lastAction(mphndlr, actnnone)
					}
...
func mapClear(mp *Map, mphndlr *MapHandler, ks ...interface{}) {
	...
	if mp != nil {
		if lstactn, actntr := mp.lastAction(mphndlr, actnclear); lstactn == actnclear || lstactn == actnclose {
			func() {
				defer func() {
					if actntr == nil {
						mp.lastAction(mphndlr, actnnone)
...
func mapClose(mp *Map, mphndlr *MapHandler) {
	...
	if mp != nil {
		if lstactn, actntr := mp.lastAction(mphndlr, actnclose); lstactn == actnclose {
			func() {
				defer func() {
					if actntr == nil {
						mp.lastAction(mphndlr, actnnone)
...
func mapValueAt(mp *Map, mphndlr *MapHandler, index int64, ks ...interface{}) (v interface{}) {
	...
	if kl := len(ks); kl > 0 {
		if vfound := mapFind(mp, mphndlr, ks...); vfound != nil {
			if vfmp, vfmpok := vfound.(*Map); vfmpok && vfmp != nil {
				mp = vfmp
			} else {
				mp = nil
...
func mapShift(mp *Map, mphndlr *MapHandler, a ...interface{}) (length int) {
	...
	if mp != nil {
		if al := len(a); al > 1 {
			ks := a[:al-1]
			arrv := a[al-1]
			if lstactn, actntr := mp.lastAction(mphndlr, atcnshift); !(lstactn == actnclear || lstactn == actnclose) && lstactn == atcnshift {
				func() {
					defer func() {
						if actntr == nil {
							mp.lastAction(mphndlr, actnnone)
	...
	if mp != nil {
		if al := len(a); al > 1 {
			...
			if a[al-1] != nil {
				...
				if len(arrv) > 0 {
					if lstactn, actntr := mp.lastAction(mphndlr, actnfindat); !(lstactn == actnclear || lstactn == actnclose) && lstactn == actnfindat {
						func() {
							defer func() {
								if actntr == nil {
									mp.lastAction(mphndlr, actnnone)
	...
	if mp != nil {
		if al := len(a); al > 1 {
			...
			if a[al-1] != nil {
				...
				if len(arrv) > 0 {
					if lstactn, actntr := mp.lastAction(mphndlr, actnat); !(lstactn == actnclear || lstactn == actnclose) && lstactn == actnat {
						func() {
							defer func() {
								if actntr == nil {
									mp.lastAction(mphndlr, actnnone)
...
func mapPush(mp *Map, mphndlr *MapHandler, a ...interface{}) (length int) {
	...
	if mp != nil {
		if al := len(a); al > 1 {
			ks := a[:al-1]
			arrv := a[al-1]
			if lstactn, actntr := mp.lastAction(mphndlr, actnpush); !(lstactn == actnclear || lstactn == actnclose) && lstactn == actnpush {
				func() {
					defer func() {
						if actntr == nil {
							mp.lastAction(mphndlr, actnnone)
...
func mapPop(mp *Map, mphndlr *MapHandler, a ...interface{}) (pop interface{}) {
	...
	if mp != nil {
		if al := len(a); al > 1 {
			ks := a
			if lstactn, actntr := mp.lastAction(mphndlr, actnpop); !(lstactn == actnclear || lstactn == actnclose) && lstactn == actnpop {
				func() {
					defer func() {
						if actntr == nil {
							mp.lastAction(mphndlr, actnnone)
...
func mapUnshift(mp *Map, mphndlr *MapHandler, a ...interface{}) (unshift interface{}) {
	...
	if mp != nil {
		if al := len(a); al > 1 {
			ks := a
			if lstactn, actntr := mp.lastAction(mphndlr, actnunshift); !(lstactn == actnclear || lstactn == actnclose) && lstactn == actnunshift {
				func() {
					defer func() {
						if actntr == nil {
							mp.lastAction(mphndlr, actnnone)
...
func mapPut(mp *Map, mphndlr *MapHandler, a ...interface{}) {
	...
	if mp != nil {
		if lstactn, actntr := mp.lastAction(mphndlr, actnput); !(lstactn == actnclear || lstactn == actnclose) && lstactn == actnput {
			func() {
				defer func() {
					if actntr == nil {
						mp.lastAction(mphndlr, actnnone)
