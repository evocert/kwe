...
import (
	...
	"github.com/evocert/kwe/goja/unistring"
)
...
// In order to make use of this method you need an event loop such as the one in goja_nodejs (https://github.com/evocert/kwe/goja_nodejs)
