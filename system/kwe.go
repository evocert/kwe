...
func main() {
	...
	var prepScheduleActionArgs func(api.ScheduleAPI, ...interface{}) ([]interface{}, error) = nil

	var glblschdlng = func() *scheduling.Schedules {
		return scheduling.GLOBALSCHEDULES(func(schdl api.ScheduleAPI, a ...interface{}) (nargs []interface{}, err error) {
			if prepScheduleActionArgs != nil {
				nargs, err = prepScheduleActionArgs(schdl, a...)
			}
			return
		}, func(rqst requesting.RequestAPI, atv *active.Active, schdl api.ScheduleAPI, a ...interface{}) error {
	...
	var executeSchdlDbms = func(schdl api.ScheduleAPI, a ...interface{}) (err error) {
		if len(a) > 0 {
	...
	var executeSchdlCommand = func(schdl api.ScheduleAPI, a ...interface{}) (err error) {
		if len(a) > 0 {
	...
	var executeSchdlRequest = func(schdl api.ScheduleAPI, a ...interface{}) (err error) {
		if serveRequest != nil {
	...
	var executeScheduleAction = func(a ...interface{}) (err error) {
		scdl, _ := a[0].(api.ScheduleAPI)
		a = a[1:]
		for len(a) > 1 {
			if cmd, cmdok := a[0].(string); cmdok && cmd != "" {
				a = a[1:]
				var cmdfnctoexec func(api.ScheduleAPI, ...interface{}) error = nil
				if cmd == "dbms" {
	...
	prepScheduleActionArgs = func(scdl api.ScheduleAPI, a ...interface{}) (preppedargs []interface{}, err error) {
		if al := len(a); al > 0 {
			ai := 0
						...
						if isactive {
							...
							if atv.ObjectMapRef == nil {
								atv.ObjectMapRef = func() (objrf map[string]interface{}) {
									...
									objref["_scheduling"] = glblschdlng().ActiveSCHEDULING(atv)
									objref["_schdl"] = schdl
	...
	lstnr.ServeRequest = func(rqst requesting.RequestAPI) error {
		return serveRequest(rqst, nil, nil, nil, nil)
	}
